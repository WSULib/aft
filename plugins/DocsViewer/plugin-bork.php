    ...
    public function embed()
    {
        foreach (__v()->item->Files as $file) {
            ...
            if (!in_array($extension, $this->_supportedFiles)) {
                echo "<div>";
				echo "<iframe src=\"";
				echo $this->_getUrl($file);
				echo "\"";
				echo "width=\"";
				echo is_admin_theme() ? get_option('docsviewer_width_admin') : get_option('docsviewer_width_public');
				echo "\"";
				echo "height=\"";
				echo is_admin_theme() ? get_option('docsviewer_height_admin') : get_option('docsviewer_height_public');
				echo "\"";
				echo "style=\"border: none; float: left;\"></iframe>";
				echo "</div>";
            }
			else { 
